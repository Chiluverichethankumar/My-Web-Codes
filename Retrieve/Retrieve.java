...
Connection c = DriverManager.getConnection("jdbc:mysql://http://localhost/phpmyadmin/index.php?route=/database/structure&db=gitam","root" , "santo1225"); // gets a new connection
